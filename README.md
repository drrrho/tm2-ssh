...
write _Perl code_ here, then this also implies _shell code_, as it is easy to invoke a shell capture
from Perl:
...
That way, if you pass in a block of several tuples into **$ssh**, then the individual tuples will be
